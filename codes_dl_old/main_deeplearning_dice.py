...
model.compile(loss='binary_crossentropy',optimizer=optimizer_adam,metrics=[jacek_auc, dice_coef])
...
filepath="model_best_dice_v1.hdf5"
...
model.save('model_best_dice_v1.h5')
...
del test_df; gc.collect()
print("writing....")
sub.to_csv('dl_dice_v1.csv',index=False)
