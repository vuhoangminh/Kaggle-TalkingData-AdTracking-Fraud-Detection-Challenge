...
def train(iSplit):
    ...
    train_df_full, train_df_delete = train_test_split(train_df_full, test_size=0.8)
    ...
    # predictors = ['app','device','os', 'channel', 'min' ,'hour', 'day', 'qty', 'ip_app_count', 'ip_app_os_count']
    # categorical = ['app', 'device', 'os', 'channel', 'min', 'hour', 'day']
    ...
    print('Save model...')
    # save model to file
    save_name = 'lightgbm_v3_split_' + str(iSplit)
