...
def lgb_modelfit_nocv(params, dtrain, dvalid, predictors, target='target', objective='binary', metrics='auc',
    ...
    bst1 = lgb.train(lgb_params, 
                     ...
                     verbose_eval=10, 
                     learning_rates=lambda iter: 0.2 * (0.997 ** iter),
                     feval=feval)
...
def train(iSplit):
    ...
    # split
    train_df, val_df = train_test_split(train_df_full, test_size=0.4)
    del train_df_full
    gc.collect()
    ...
    predictors = ['app','device','os', 'channel','hour', 'ipcount', 'qty', 'ip_app_count', 'ip_app_os_count']
    # categorical = ['app', 'device', 'os', 'channel', 'hour']
    # predictors = ['app', 'device', 'os', 'channel', 'hour', 'min']
    # categorical = ['app', 'device', 'os', 'channel', 'hour', 'min']
    ...
    params = {
        ...
        'scale_pos_weight': 80, # because training data is extremely unbalanced 
    ...
    print('Save model...')
    # save model to file
    save_name = 'lightgbm_v6_split_' + str(iSplit)
