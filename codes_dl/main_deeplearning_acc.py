...
filepath="model_best_acc_" + str(which_dataset) + ".hdf5"
savepath = "model_best_acc_" + str(which_dataset) + ".h5"
csvpath = "dl_acc_" + str(which_dataset) + ".csv"
logpath = "log_dl_acc_" + str(which_dataset) + ".csv"
