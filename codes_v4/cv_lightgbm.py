...
def DO(frm,to,fileno):
    ...
    if noday:
        subfilename = boosting_type + '_cv_noday_sub_it_' + str(int(100*frac)) + 'percent_%d_%d_%d_%d.csv'%(frm,to,num_leaves,max_depth)
        modelfilename = boosting_type + '_cv_noday_sub_it_' + str(int(100*frac)) + 'percent_%d_%d_%d_%d'%(frm,to,num_leaves,max_depth)
    else:
        subfilename = boosting_type + '_cv_sub_it_' + str(int(100*frac)) + 'percent_%d_%d_%d_%d.csv'%(frm,to,num_leaves,max_depth)
        modelfilename = boosting_type + '_cv_sub_it_' + str(int(100*frac)) + 'percent_%d_%d_%d_%d'%(frm,to,num_leaves,max_depth)
