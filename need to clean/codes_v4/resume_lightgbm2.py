...
def DO(frm,to,fileno):
    ...
    params = {
        ...
        'min_child_samples': 19,  # Minimum number of data need in a child(min_data_in_leaf)
        'max_bin': 884,  # Number of bucketed bin for feature values
        'subsample': 0.45,  # Subsample ratio of the training instance.
        'subsample_freq': 1,  # frequence of subsample, <=0 means no enable
        'colsample_bytree': 0.96,  # Subsample ratio of columns when constructing each tree.
