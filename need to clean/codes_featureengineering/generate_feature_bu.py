...
def feature_engineering(train_df):
    ...
    print('Total memory in use: ', process.memory_info().rss/(2**30), ' GB\n') 
    # if debug:
    print('After automate feature engineering...')
    print(train_df.head())         
    print(train_df.tail())      
    return train_df

def manual_feature_engineering(train_df, len_train, val_size, click_id_df):
    print('=======================================================================')
    ...
    train_df['click_id'] = click_id_df['click_id']
...
def DO(frm,to,fileno):
    ...
    train_df['click_id']=range(len(test_df)+1, len(train_df)+len(test_df)+1)
    ...
    click_id_df = pd.DataFrame()
    click_id_df['click_id'] = train_df['click_id']
    train_df = train_df.drop(['click_id'], axis=1) 
    if debug:
        print('after drop...')
        print(train_df.head())
        print(train_df.tail())
        print(click_id_df.tail())
    ...
    print('Total memory in use:', process.memory_info().rss/(2**30), ' GB\n')   
    manual_feature_engineering(train_df,len_train,val_size,click_id_df)
    print('Total memory in use:', process.memory_info().rss/(2**30), ' GB\n')        
