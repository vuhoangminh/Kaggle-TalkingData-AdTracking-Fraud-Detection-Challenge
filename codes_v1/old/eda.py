...
#     if 'zip' not in f:
#         print(f.ljust(30) + str(round(os.path.getsize(path + f) / 10000000, 2)) + 'MB')
...
# df_test = pd.read_csv('../input/test.csv', nrows=10000000)

print ('load train...')
df_train = pd.read_csv('../input/train.csv', nrows=20000000)
print ('load test...')
