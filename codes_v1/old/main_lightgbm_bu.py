...
# 
print ("load train...")
train_df = pd.read_pickle('train_0')
print(df.head())

print ("load test...")
test_df = pd.read_pickle('test')

validrows = int(loadrows/5)
val_df = train_df[(len_train-validrows):len_train]
train_df = train_df[:(len_train-validrows)]
...
print("writing...")
sub.to_csv('sub_lgb_balanced2.csv',index=False)
print("done...")